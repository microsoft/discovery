...
#
# All non-Discovery prerequisites plus the RG-level storageContainer binding.
# Mirrors the monolithic root's network.tf / identity.tf / storage.tf / roles.tf
# so the control-plane modules (02, 03) receive exactly the inputs they expect.
# -----------------------------------------------------------------------------
...
# it lives here with the storage prerequisites it depends on. The e2e completion
# root (04) references this ID when creating the project.
# -----------------------------------------------------------------------------
