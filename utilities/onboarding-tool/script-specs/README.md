...
| 5 Scenario enablement | `stage5-scenario-enablement/stage5_enable.ps1` | [`stage5-scenario-enablement/stage5_enable.md`](stage5-scenario-enablement/stage5_enable.md) | connectivity_check, create_tool, create_agent_bind_tool, create_investigation_conversation, send_prompt_poll, assert_tool_invocation, verification_summary |
